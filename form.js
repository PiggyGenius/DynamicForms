...
function updatePreview() {
    ...
    container.innerHTML += "<div class=\"element\" id=\"elem"+i+"\"></div>";
	...
	case "TextField": 
	    new_elem.innerHTML += "<input name=\""+'TEXTFIELD'+i+"\" type=\"text\"><br>";
	    break;
	    
	case "TextArea":
	    new_elem.innerHTML += "<textarea name=\""+'TEXTAREA'+i+"\"rows=\"4\" cols=\"50\"></textarea><br>";
	    break;

	case "DateInput":  
	    new_elem.innerHTML += "<input name=\""+'DATE'+i+"\" type=\"date\"><br>";
	    break;

	case "List":  
	    new_elem.innerHTML += "<select name=\""+'LIST'+i+"\" id=\"select_tmp\"></select>";
		var foo;
	...
	case "CheckBoxGroup": 
	    for(j=0 ; j<elements[i][3].length ; j++)
		    new_elem.innerHTML += "<input type=\"checkbox\" name=\""+'CHECKBOX'+i+"[]\" value=\""+j+"\">" + elements[i][3][j] + "<br>";
	    break;
	    
	case "RadioButtonGroup": 
	    for(j=0 ; j<elements[i][3].length ; j++)
		    new_elem.innerHTML += ("<input type=\"radio\" value=\""+j+"\" name=\""+'RADIOBUTTON'+i+"\">" + elements[i][3][j] + "<br>");
	    break;
